...
|:-----------|:------|:-----------|
| [T2V Foundation Models](t2v/foundation.html) | Core text-to-video synthesis | Sora, Wan 2.1, Veo 2, CogVideoX, LaVIE |
| [Controllable Synthesis](t2v/controllable.html) | Controllable and efficient video generation | AnimateDiff, ControlVideo, VideoComposer |
| [T2V Benchmarks](t2v/benchmarks.html) | Video generation benchmarks and datasets | VBench, EvalCrafter, FETV |
| [I2V Animation & Portraits](i2v/animation.html) | Image animation, talking heads, character-driven video | LivePortrait, Animate Anyone, MagicAnimate |
| [I2V Video Editing](i2v/editing.html) | Video editing, motion transfer, enhancement | TokenFlow, Rerender-A-Video, CoDeF |
