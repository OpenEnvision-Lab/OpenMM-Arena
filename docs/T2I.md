...
|:-----------|:------|:-----------|
| [Models & Face Synthesis](t2i/models.html) | Foundational T2I models, face generation | FLUX.2, Seedream 3.0, Imagen 3, PixArt-α, Stable Diffusion |
| [Control & Composition](t2i/control.html) | Controllable generation, layout control | ControlNet, GLIGEN, Uni-ControlNet, DreamBooth |
| [Editing & Personalization](t2i/editing.html) | Text-guided editing, personalization | InstructPix2Pix, DreamBooth, Blended Diffusion |
| [Safety & Applications](t2i/safety.html) | Safety, bias, evaluation, applications | SafeGen, OpenBias, DIAGNOSIS |
| [Cross-Modal Extensions](t2i/crossmodal.html) | Video, 3D, motion from T2I | AnimateDiff, DreamFusion, Text2LIVE |
| [Arena & Benchmarks](t2i/arena.html) | Leaderboards, benchmarks, metrics | LM Arena (46 models), HEIM, GenEval |
