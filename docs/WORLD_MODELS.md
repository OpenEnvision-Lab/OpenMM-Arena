...
|:-----------|:------|:-----------|
| [Theory & Surveys](world/theory.html) | Theoretical foundations, surveys, scaling laws | 20+ surveys |
| [Game Simulation](world/simulation.html) | Interactive game engines, virtual worlds | GameNGen, DIAMOND, Oasis |
| [Video Generation](world/videogen.html) | Video generation as world simulation | Sora, Cosmos, Genie |
| [LiDAR Generation](world/lidargen.html) | LiDAR point cloud world models | LiDAR-based driving models |
| [Occupancy Generation](world/occgen.html) | 3D occupancy prediction and generation | OccWorld, occupancy models |
| [Embodied AI](world/embodied.html) | Manipulation, navigation, locomotion, MBRL | TesserAct, DreamGen, Dreamer v4 |
...
## World Models x VLAs & Model-Based RL
